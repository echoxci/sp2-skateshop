<header class="masthead py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder text-white">Pridaj produkt</h1>
            <hr class="divider">
        </div>
    </div>
</header>
        ...
        <div class="col-lg-8 align-self-baseline">
            <form id="add-product-form" method="post" action="/?c=product&a=add&category_id=<?= $_GET["category_id"] ?>">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" step="0.01" name="price" id="input-new-product-price" class="form-control" value="0.00" required>
                    </div>
                </div>
                <div class="mb-3 row">
